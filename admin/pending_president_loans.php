...
$loans = $adminLoan->getPresidentPendingLoans();
?>
...
<div class="container">
    <div class="card shadow">
        <div class="card-header d-flex align-items-center">
            <h4>Approved Loans by comakers and financial committees </h4>
        </div>
        <div class="card-body">
                    ...
                    <table class="table" id="myTable">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($loans as $key => $singleLoan) : ?>
                                <?php if (is_null($singleLoan->reason_for_decline)) : ?>
                                    <tr class="align-items-center">
                                        ...
                                        <td class="text-center">
                                            <?php if ($singleLoan->approved_by_president) : ?>
                                        ...
                                        <td class="d-flex">
                                            <form action="pending_president_loan_update.php" method="POST">
                                            ...
                                            <form action="pending_president_loan_delete.php" method="POST">
                                                <input type="hidden" name="id" value="<?php echo $singleLoan->id ?>">
