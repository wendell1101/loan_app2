            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                ...
                <div class="from-group">
                    ...
                    <select name="approved" id="approved" class="form-control" required>
                        ...
                        <option value="1" <?php if ($adminLoan->checkIfActiveFinancialCommitteeHasApproved($activeLoan->id) != 0) : ?> selected <?php endif; ?>>Approve</option>
                        <option value="0" <?php if ($adminLoan->checkIfActiveFinancialCommitteeHasApproved($activeLoan->id) == 0) : ?> selected <?php endif; ?>>Disapprove</option>
                    </select>
                </div>
