                            ...
                            <?php foreach ($user_loans as $key => $u_loan) : ?>
                                <li class="list-group-item" style="list-style-type:disc">
                                    ...
                                    <div><?php echo $key + 1 ?>.
                                        ...
                                        <small>*Principal Interest Amount:</small> <b>PHP <?php echo formatDecimal($u_loan->interest_amount) ?></b><br>
                                        ...
                                        <small>*Total Current Balance:</small> <b>PHP <?php echo formatDecimal($u_loan->total_amount) ?></b><br>
