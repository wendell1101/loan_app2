...
<div class="wrapper">
    <div class="container">
        ...
        <div class="row mt-5">
            <a href="loan_create_regular.php" class="col-md-5 m-auto bg-secondary mb-2 d-flex border align-items-center justify-content-center rounded loan-type-box" style="min-height: 200px; margin-bottom: .5rem!important">
                <div class="text-center">
                    <h5 class="text-white">Regular</h5>
                    <p class="text-center text-white">1% Interest Rate</p>
                </div>
            </a>
            <a href="loan_create_character.php" class="col-md-5 m-auto bg-secondary mb-2 d-flex border align-items-center justify-content-center rounded loan-type-box" style="min-height: 200px">
                <div class="text-center">
